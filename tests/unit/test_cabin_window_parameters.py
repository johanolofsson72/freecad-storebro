...
def test_defaults_construct() -> None:
    ...
    assert p.count_per_side == 2  # spec 033 orientation fix (2.4 m forward cabin)
    assert p.length == 850.0  # spec 033 orientation fix
    assert p.height == 500.0  # spec 033 orientation fix
