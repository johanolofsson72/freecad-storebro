...
- [/] 007 — hull-fidelity-refresh — full track — Re-derive hull silhouette to match the storebropassion.de RC34 1972 reference (`docs/references/Alternativ3.JPG` profile): blunt stem, near-vertical stem rake (~6°), reduced sheer differential, smooth `Ruled=False` loft now that the stem is non-degenerate, plus optional chine. Visual fidelity over alpha-grade wedge.
